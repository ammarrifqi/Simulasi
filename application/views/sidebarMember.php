  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?php echo ($this->session->userdata('title')=="Member Telehealth") ? "active" : ""?>">
          <a href="<?php echo base_url()?>C_member"><i class="fa fa-home"></i> <span>Halaman Utama</span></a>
        </li>
        ...
        <li class="<?php echo ($this->session->userdata('title')=="Konsultasi Dokter") ? "active" : ""?>">
          <a href="<?php echo base_url('C_konsultasi')?>"><i class="fa fa-stethoscope"></i> <span>Konsultasi Dokter</span></a>
        </li>
        <li class="<?php echo ($this->session->userdata('title')=="Saran Resep Obat") ? "active" : ""?>">
          <a href="<?php echo base_url('C_konsultasi/saranResep')?>"><i class="fa fa-medkit"></i> <span>Saran Resep Obat</span></a>
        </li>
